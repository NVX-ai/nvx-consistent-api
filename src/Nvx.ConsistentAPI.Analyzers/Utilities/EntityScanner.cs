...
public static class EntityScanner
{
  ...
  (
    ...
    where i.OriginalDefinition.ContainingNamespace.ToDisplayString() == "Nvx.ConsistentAPI.Framework.Entities"
  ...
  private static IEnumerable<ITypeSymbol> GetFoldEventsFromInterface(
    ...
    where interfaceSymbol.ContainingNamespace.ToDisplayString() == "Nvx.ConsistentAPI.Framework.Entities"
